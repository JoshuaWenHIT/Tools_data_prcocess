...
img_ori = cv2.imread('/media/joshuawen/SSD_2/Paper/CenterCounter/image_mat/exp/video_results/method1/7/feature_map_frame_318/ret_reg_layers_resize/channel_2.jpg')
img_rgb = cv2.applyColorMap(img_ori, cv2.COLORMAP_JET)
cv2.imwrite('/media/joshuawen/SSD_2/Paper/CenterCounter/image_mat/exp/video_results/method1/7/feature_map_frame_318/ret_reg_layers_resize/RGB_channel_2.jpg', img_rgb)
